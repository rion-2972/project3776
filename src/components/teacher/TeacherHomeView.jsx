...
import { collection, query, where, getDocs, collectionGroup, orderBy, onSnapshot } from 'firebase/firestore';
...
const TeacherHomeView = () => {
    ...
    const fetchAssignmentProgress = async (assignmentsList) => {
        try {
            const progress = {};

            for (const assignment of assignmentsList) {
                // Count eligible students (those who have the subject)
